...
DAILY_PLAN_SYSTEM = (
    ...
    "the merchant's or type's avg_views_per_day COPIED VERBATIM from the context "
    "(MERCHANT_MIX / POST_TYPE_PERFORMANCE) — never invent, round, or scale a per-post "
    "number (do NOT write things like 'expect ~4 views'); if no such figure is in the "

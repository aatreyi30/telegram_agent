...
import { BarsChart, MultiLineChart, StackedBarsChart, TimelineChart } from "@/components/charts";
...
export function Analytics() {
  ...
  return (
    <div>
      <PageHeader title="Analytics" sub="Views, reactions, forwards, engagement, CTA, and growth — all from the data we collect." />
